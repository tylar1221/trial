...
import requests  # For making API calls to Gemini API
...
def translate_text_using_gemini(text, target_language, api_key):
    url = "https://gemini.googleapis.com/v1alpha1/translations:translateText"
    headers = {
...
if options:
    ...
    with col2:
        ...
        # Add multilingual translation using Gemini API
        ...
        # API Key for Gemini API (PaLM)
        api_key = "YOUR_GEMINI_API_KEY_HERE"  # Add your API key here

        if st.button("Translate"):
            translated_text = translate_text_using_gemini(converted_prediction, language_options[selected_language], api_key)
